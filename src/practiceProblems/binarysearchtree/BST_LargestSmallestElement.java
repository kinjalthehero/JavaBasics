...
class BST_LargestSmallestElement {
    ...
    static class BinarySearchTree {
        ...
        int findLargestSmallerKey(int num) {
            ...
            int largestSmallestKey = -1;

            while (root != null) {
                if (root.key < num) {
                    largestSmallestKey = root.key;
                    root = root.right;
        ...
        void insert(int key) {
            ...
            // 1) If the tree is empty, creatthe root
            if(this.root == null) {
    ...
    public static void main(String[] args) {
        ...
        /*int result = bst.findLargestSmallerKey(100);
        System.out.println("Largest smaller number is " + result);

        result = bst.findLargestSmallerKey(1);
        System.out.println("Largest smaller number is " + result);

        result = bst.findLargestSmallerKey(25);
        System.out.println("Largest smaller number is " + result);*/
